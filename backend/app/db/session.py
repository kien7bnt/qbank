    ...
    async with engine.begin() as conn:
        ...
        def _run_migrations(sync_conn):
            ...
            columns_to_ensure = [
                ...
                ("exams", "max_question_overlap", "DOUBLE PRECISION DEFAULT 0.5", "FLOAT DEFAULT 0.5"),
                ("exams", "random_seed_strategy", "VARCHAR(50) DEFAULT 'student_attempt'", "VARCHAR(50) DEFAULT 'student_attempt'"),
                # assignments
                ...
                ("assignments", "is_random_per_student", "BOOLEAN DEFAULT FALSE", "BOOLEAN DEFAULT 0"),
                ("assignments", "questions_per_instance", "INTEGER", "INTEGER"),
                ("assignments", "max_question_overlap", "DOUBLE PRECISION DEFAULT 0.5", "FLOAT DEFAULT 0.5"),
                ...
                # exam_attempts
                ("exam_attempts", "instance_id", "UUID", "CHAR(32)"),
