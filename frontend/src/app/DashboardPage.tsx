...
export function DashboardPage() {
  ...
  return (
    <div className="p-3 sm:p-4 max-w-7xl mx-auto space-y-3">
      {/* 1. Welcome Banner (Compact) */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#4361EE] via-[#4F70F5] to-[#5978F8] px-4 py-3 sm:px-5 sm:py-3.5 text-white shadow-2xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          ...
          <div className="shrink-0">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/20 border border-white/25 text-white text-xs font-medium backdrop-blur-xs shadow-2xs">
      ...
      {/* 2. KPI Cards Grid (Compact & Role-Specific) */}
      {isTeacher ? (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {/* Card 1: Tổng số câu hỏi */}
          <div
            onClick={() => navigate('/question-bank')}
            className="bg-white border border-gray-100 rounded-xl p-3 sm:p-3.5 shadow-2xs hover:border-blue-200 hover:shadow-xs transition-all cursor-pointer group"
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Tổng số câu hỏi</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {totalQuestionsDisplay}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Câu hỏi trong ngân hàng</p>
            </div>
          </div>
          ...
          <div
            ...
            className="bg-white border border-gray-100 rounded-xl p-3 sm:p-3.5 shadow-2xs hover:border-purple-200 hover:shadow-xs transition-all cursor-pointer group"
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Bài kiểm tra</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {totalExamsCount}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Đề thi & bài tập đã tạo</p>
            </div>
          </div>
          ...
          <div
            ...
            className="bg-white border border-gray-100 rounded-xl p-3 sm:p-3.5 shadow-2xs hover:border-emerald-200 hover:shadow-xs transition-all cursor-pointer group"
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Lượt làm bài</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {totalSubmissionsDisplay}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Lượt học sinh đã nộp</p>
            </div>
          </div>

          {/* Card 4: Kho tài liệu (Thay cho Bài cần chấm) */}
          <div
            onClick={() => navigate('/document-library')}
            className="bg-white border border-gray-100 rounded-xl p-3 sm:p-3.5 shadow-2xs hover:border-amber-200 hover:shadow-xs transition-all cursor-pointer group"
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Kho tài liệu</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {totalDocsCount}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Tài liệu & giáo trình đã lưu</p>
            </div>
          </div>
        </div>
      ) : (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Lớp học của tôi</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {classesList.length}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Lớp đang theo học</p>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Bài cần làm</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {pendingStudentAssignments.length}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Bài tập & đề thi chưa nộp</p>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Đã hoàn thành</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {completedAttempts > 0 ? completedAttempts : completedStudentAssignments.length}
              </p>
              <p className="text-[11px] text-gray-400 font-normal mt-0.5 truncate">Bài đã nộp & có kết quả</p>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-semibold text-gray-700">Điểm trung bình</span>
            </div>
            <div className="mt-2">
              <p className="text-2xl font-bold text-gray-900 tracking-tight leading-tight">
                {studentAvgScore}
      ...
      {/* 3. Main Section: Side-by-Side to fit without vertical scrolling */}
      {isTeacher ? (
        /* Teacher: Left = Biểu đồ lớp, Right = Đợt kiểm tra & bài tập */
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5">
          {/* Left Column: Kết quả học tập theo lớp (5 cols) */}
          <div className="lg:col-span-5 bg-white border border-gray-100 rounded-xl p-4 shadow-2xs flex flex-col h-[calc(100vh-14.5rem)] min-h-[310px] max-h-[380px]">
            <div className="flex items-center justify-between mb-2 shrink-0">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center">
                  <TrendingUp className="h-3.5 w-3.5" />
                </div>
                <h2 className="text-xs sm:text-sm font-bold text-gray-900">Kết quả học tập theo lớp</h2>
              </div>
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white border border-gray-200 rounded-lg px-2.5 py-1 pr-7 text-[11px] font-medium text-gray-700 hover:border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 cursor-pointer shadow-2xs"
                >
                  <option value="score">Điểm TB</option>
            ...
            {chartClasses.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-4 bg-gray-50/50 rounded-xl border border-dashed border-gray-200">
                <div className="w-9 h-9 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center mb-2">
                  <GraduationCap className="w-5 h-5" />
                </div>
                <h4 className="text-xs font-semibold text-gray-800 mb-0.5">Chưa có dữ liệu lớp học</h4>
                <p className="text-[11px] text-gray-500 max-w-xs mb-3">Tạo lớp học và giao bài để theo dõi thống kê kết quả học tập tại đây.</p>
                <button
                  onClick={() => navigate('/classes')}
                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-[#5470F5] hover:bg-[#4361EE] text-white rounded-lg text-xs font-semibold shadow-2xs transition-colors"
                >
                  <Plus className="w-3.5 h-3.5" /> Thêm lớp học
                </button>
              </div>
            ) : (
              <div className="flex-1 flex flex-col justify-between pt-2 pb-1 min-h-0">
                <div className="relative flex-1 flex">
                  {/* Y Axis Numbers */}
                  <div className="w-9 flex flex-col justify-between text-right pr-2 text-[10px] font-medium text-gray-400 select-none pb-5">
                    {chartMetric === 'score' ? (
                      <>
                        <span>10</span>
                        <span>8</span>
                  ...
                  <div className="relative flex-1 flex flex-col justify-between">
                    ...
                    {/* Bars Row */}
                    <div className="absolute inset-x-0 top-0 bottom-5 flex items-end justify-around px-2 sm:px-4">
                      {chartClasses.map((item, idx) => {
                        ...
                        return (
                          ...
                          >
                            {/* Value label */}
                            <span className="text-[10px] font-bold text-gray-700 mb-1 transition-transform group-hover:-translate-y-0.5">
                              {item.displayValue}
                            </span>
                            ...
                            <div
                              ...
                              className="w-10 sm:w-14 bg-[#5470F5] hover:bg-[#4361EE] rounded-t-sm transition-all duration-300 shadow-2xs"
                            />
                          </div>
                        );
                      })}
                    ...
                    {/* X Axis Labels */}
                    <div className="absolute inset-x-0 bottom-0 h-5 flex items-center justify-around px-2 sm:px-4">
                      {chartClasses.map((item, idx) => (
                        <div
                          key={item.id || idx}
                          className="w-10 sm:w-14 text-center text-[10px] font-semibold text-gray-700 truncate"
                          title={item.name}
                        >
                          {item.name}
                        </div>
          ...
          <div className="lg:col-span-7 bg-white border border-gray-100 rounded-xl p-4 shadow-2xs flex flex-col h-[calc(100vh-14.5rem)] min-h-[310px] max-h-[380px]">
            <div className="flex items-center justify-between mb-2 shrink-0">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center">
                  <FileText className="h-3.5 w-3.5" />
                </div>
                <h2 className="text-xs sm:text-sm font-bold text-gray-900">Đợt kiểm tra & Bài tập</h2>
              </div>

              <div className="flex items-center gap-1.5">
                {/* Tabs switch */}
                <div className="inline-flex rounded-lg bg-gray-100/90 p-0.5 text-[11px] font-medium text-gray-600">
                  <button
              ...
              <table className="w-full text-left text-xs">
                <thead className="sticky top-0 bg-white z-10">
                  <tr className="border-b border-gray-100 text-[11px] text-gray-400 font-medium">
                    <th className="py-2 px-2.5">Tên</th>
                    <th className="py-2 px-2.5">Lớp</th>
                    <th className="py-2 px-2.5">Thời gian</th>
                    <th className="py-2 px-2.5">Đã làm</th>
                    <th className="py-2 px-2.5">Điểm TB</th>
                ...
                <tbody className="divide-y divide-gray-50">
                  {tableRows.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="py-10 text-center text-gray-400">
                        <div className="flex flex-col items-center justify-center gap-1.5">
                          ...
                          <button
                            onClick={() => navigate('/assignments')}
                            className="inline-flex items-center gap-1 px-2.5 py-1 bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg text-xs font-semibold mt-0.5 transition-colors"
                          >
                            <Plus className="w-3 h-3" /> Giao bài mới
                          </button>
                        </div>
                      </td>
                    </tr>
                    ...
                    tableRows.map((row: any) => (
                      ...
                      >
                        <td className="py-2.5 px-2.5 font-semibold text-gray-800 text-xs max-w-[150px] truncate" title={row.name}>
                          {row.name}
                        </td>
                        <td className="py-2.5 px-2.5 font-medium text-gray-700 text-[11px] max-w-[100px] truncate" title={row.class_name}>
                          {row.class_name}
                        </td>
                        <td className="py-2.5 px-2.5 text-gray-500 text-[11px]">
                          {row.time}
                        </td>
                        <td className="py-2.5 px-2.5 font-medium text-gray-700 text-[11px]">
                          {row.done_ratio}
                        </td>
                        <td className="py-2.5 px-2.5 font-bold text-gray-800 text-[11px]">
                          {row.avg_score}
                        </td>
          ...
          <div className="lg:col-span-5 bg-white border border-gray-100 rounded-xl p-4 shadow-2xs flex flex-col h-[calc(100vh-14.5rem)] min-h-[310px] max-h-[380px]">
            <div className="flex items-center justify-between mb-2.5 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xs sm:text-sm font-bold text-gray-900">Lớp học của tôi</h2>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1 bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg text-[11px] font-semibold transition-colors"
              >
                <Plus className="w-3 h-3" /> Tham gia lớp
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto min-h-0 space-y-2 pr-1">
              {classesList.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-4">
                  <GraduationCap className="w-9 h-9 text-gray-300 mb-2" />
                  <p className="text-xs font-semibold text-gray-700">Chưa tham gia lớp học nào</p>
                  <p className="text-[11px] text-gray-400 mt-0.5 mb-3">Nhập mã lớp từ giáo viên để tham gia lớp học</p>
                  <button
                    onClick={() => navigate('/classes')}
                    className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-medium shadow-2xs transition-colors"
                  >
                ...
                classesList.map((c: any) => (
                  <div
                    ...
                    className="p-2.5 rounded-lg border border-gray-100 hover:border-blue-200 hover:bg-blue-50/20 transition-all cursor-pointer flex items-center justify-between group"
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] text-gray-500 mt-0.5">
                          <span className="font-mono bg-gray-100 px-1 py-0.2 rounded text-gray-600 font-medium">
                            {c.code}
                          </span>
                          <span>•</span>
                    ...
                    <ArrowRight className="w-3.5 h-3.5 text-gray-300 group-hover:text-blue-600 group-hover:translate-x-0.5 transition-all shrink-0" />
                  </div>
                ))
              )}
            </div>
          ...
          <div className="lg:col-span-7 bg-white border border-gray-100 rounded-xl p-4 shadow-2xs flex flex-col h-[calc(100vh-14.5rem)] min-h-[310px] max-h-[380px]">
            <div className="flex items-center justify-between mb-2.5 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xs sm:text-sm font-bold text-gray-900">Bài tập & Đợt kiểm tra</h2>
              </div>
            ...
            <div className="flex-1 overflow-y-auto min-h-0 -mx-4 px-4 divide-y divide-gray-50">
              {studentFilteredAssignments.length === 0 ? (
                ...
                studentFilteredAssignments.map((a: any) => {
                  ...
                  return (
                    <div
                      key={a.id}
                      className="py-2.5 flex items-center justify-between gap-3 hover:bg-gray-50/50 rounded-lg px-2 transition-colors"
                    >
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="text-xs font-semibold text-gray-800 truncate" title={a.name}>
                            {a.name}
                          </h4>
                        </div>
                        ...
                        {isSubmitted ? (
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-blue-600 hover:bg-blue-50 rounded-lg border border-blue-200 transition-colors"
                            >
                              Xem kết quả
                            </button>
                          </div>
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium bg-amber-500 hover:bg-amber-600 text-white rounded-lg shadow-2xs transition-colors"
                          >
                            Tiếp tục làm
                          </button>
                        ) : (
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-2xs transition-colors"
                          >
                            <Play className="w-3 h-3 fill-white" /> Làm bài
                          </button>
                        )}
                      </div>
                    </div>
